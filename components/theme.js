...
export const COLORS = {
    primary: "#1C6184",     //  Dark Blue
    primary2: "#DCEAFF",    //  Light Blue
    primary3: "#42C6A5",    // Green
...
export const FONTS = {
    ...
    h3: { fontFamily: "Roboto-Bold", fontSize: SIZES.h3, lineHeight: 27 },
    h4: { fontFamily: "Roboto-Bold", fontSize: SIZES.h4, lineHeight: 22 },
    h5: { fontFamily: "Roboto-Bold", fontSize: SIZES.h5, lineHeight: 10 },
    h6: { fontFamily: "Roboto-Bold", fontSize: SIZES.h6, lineHeight: 8, letterSpacing: -.50},
